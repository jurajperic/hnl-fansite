...
export const ClubInfo = () => {
  const { fetchClubData, clubData, loading, setLoading, fetchPlayers } =
    useGlobalContext();
      ...
      <div className="clubInfo-container">
        <div className="first-part">
          ...
          <div className="clubInfo-column">
            ...
            <p>
              Stadion:{" "}
              <a className="stadium-link" href={`/stadiums/${club.stadium}`}>
                {stadiumsInfo.find((stad) => stad.id === club.stadium).name}
              </a>
            </p>
